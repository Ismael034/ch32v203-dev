...
| 1 | U18 | USB-C receptacle KH-TYPE-C-16P | `ch32v203_dev:USB-C-SMD_KH-TYPE-C-16P` |
...
| 2 | U26, U28 | DMG2305UX-7 MOSFET | `ch32v203_dev:SOT-23-3_L2.9-W1.3-P1.90-LS2.4-BR` |
...
| 1 | C9 | 4.7 uF capacitor | `Capacitor_SMD:C_0402_1005Metric` |
| 1 | C13 | 10 uF capacitor | `Capacitor_SMD:C_0402_1005Metric` |
| 3 | C6, C7, C8 | 100 nF capacitors | `Capacitor_SMD:C_0402_1005Metric` |
| 4 | C3, C4, C10, C11 | 15 pF capacitors | `Capacitor_SMD:C_0402_1005Metric` |
| 2 | R7, R8 | 1 kOhm resistors | `Resistor_SMD:R_0402_1005Metric` |
| 2 | R9, R1 | 5.1 kOhm resistors | `Resistor_SMD:R_0603_1608Metric` |
| 2 | R5, R2 | 10 kOhm resistors | `Resistor_SMD:R_0603_1608Metric` |
